...
static int mmc_read_ext_csd(struct mmc_card *card, u8 *ext_csd)
{
	...
	if (card->ext_csd.rev >= 4) {
		...
		card->ext_csd.sec_erase_mult =
			ext_csd[EXT_CSD_SEC_ERASE_MULT];
//&*&*&*SJ1_20120629, [NV patch] Disable secure erase to fix Hynix 16GB eMMC factory data reset erase time too long issue.
//		card->ext_csd.sec_feature_support =
//			ext_csd[EXT_CSD_SEC_FEATURE_SUPPORT];
//&*&*&*SJ2_20120629, [NV patch] Disable secure erase to fix Hynix 16GB eMMC factory data reset erase time too long issue.
